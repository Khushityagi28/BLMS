        ...
        <div class="container">
            ...
            <div class="role-message">
                ...
                <% } else if ("Teacher".equals(role)) { %>
                    ...
                    <p>As a Teacher, you can create and manage courses, interact with students, and track progress.</p>
                <% } else if ("Student".equals(role)) { %>
                    <i class="fas fa-user-graduate icon"></i>
                    <p>As a Student, you have access to course materials, assignments, and interactive learning tools.</p>
                <% } else { %>
